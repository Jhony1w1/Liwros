...
class Usuario {
	...
	public static function getByCorreoAndPass($email, $passwd) {

		// Build database query
		$sql = "select * from usuarios where correo='$email' AND password='$passwd'";
	...
	public static function getById($id) {
		...
		if ($statement->prepare($sql)) {
			...
			$statement->bind_result($id, $login, $password, $nombre, $correo, $admin, $fechaCreacion);
